<template>
  <div class="
    w-full  
    flex items-center border border-[var(--color-border-light)] rounded-[var(--radius-sm)] px-4 py-1 
    focus-within:ring-1   
    overflow-hidden
    mr-2 lg:mr-6 
    h-[var(--header-mobile-search-height)] lg:h-10 
  ">
